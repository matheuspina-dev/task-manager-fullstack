  ...
  return (
    <div className="flex">
      ...
      >
        {activeView !== "stats" ? (
          <div>
            <div className="flex flex-col gap-y-8 mt-8 w-full justify-self-start text-3xl">
              <TaskList
                tasks={filteredTasks}
            ...
            <div>
              <button
                ...
                className="bg-tanager-primary px-8 py-4 mt-4 rounded-lg text-white cursor-pointer"
              >
                + Add Task
              </button>
            </div>
